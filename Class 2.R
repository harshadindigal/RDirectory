...
boston <-  read_delim(file = "./Data/Boston.csv", delim = ",")

# Specifying column types
boston <-  read_delim(file = "./Data/Boston.csv",
                      delim = ",",
...
mpg <-  read_delim(file = "./Data/mpg.txt", 
...
student_data <- read_excel(path = "./Data/Student Performance.xlsx")
...
clinton_first <- read_lines(file = "./data/clinton_1st.txt")
...
save(boston, file = "./boston_data_frame_file") 

# To load R data frame, specify the file path 
load(file = "./boston_data_frame_file")

# Save as a CSV
write.table(boston,
            file = "./boston_csv_test.csv",
            sep = ",", row.names = FALSE)

# Save as tab delimited
# Same as above, just change .csv to .txt and sep = "\t"
write.table(boston,
            file = "./boston_txt_test.txt",
            sep = "\t", row.names = FALSE)
...
## Combining Steps With The %>% Pipe Operator
